...
// Sessiooni haldus
    ...
    $picCount = countUsersPictures($userid);
    ...
    $gallery = showUsersPrivatePictures($userid, $page, $limit);
?>
		...
		<div class="modalHorizontal">
			...
			<p id="modalCaption"></p>
				...
				<div id="rating" class="modalRating">
                    ...
                    <button id="deletePic">KUSTUTA</button><p id="deleteInf"></p>
					<br>
					<p id="avgRating"></p>
				</div>
