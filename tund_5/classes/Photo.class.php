<?php
    ...
    class Photo {
        ...
        function __construct($picToUpload, $imageFileType, $fileUploadSizeLimit) {
            ...
            // Hiljem tuleks kõigepealt selgitada, kas sobiv fail üleslaadimiseks ja siis ka imageFiletype kindlaks teha klassi sees
            // $this->imageFileType = $this->checkImgType();
        ...
        public function checkPhotoSize() {
            $sizeCheck = null;
            if($_FILES["fileToUpload"]["size"] > $this->fileUploadSizeLimit){
                $sizeCheck = 0;
            } else {
                $sizeCheck = 1;
            }
        ...
        public function generateName() {
            ...
            $fileName = $fileNamePrefix . $timestamp . "." .$this->imageFileType;
