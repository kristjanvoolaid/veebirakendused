<?php
    ...
    class Photo {
        ...
        public function checkImgForUpload() {
            ...
            // Suuruse check
            if ($this->error == null and $this->picToUpload["tmp_name"] > $this->fileUploadSizeLimit) {
                $this->error = 2;
            }
        ...
        public function generateName($fileNamePrefix) {
        ...
        public function saveOriginal($fi, $target) {
            $notice = null;
            if(move_uploaded_file($fi, $target)){
